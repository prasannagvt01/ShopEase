...
import { ArrowLeftIcon, TruckIcon, CheckCircleIcon, ArrowDownTrayIcon, PrinterIcon } from '@heroicons/react/24/outline';
...
export default function AdminOrderDetails() {
  ...
  const statuses = ['PENDING', 'CONFIRMED', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'RETURN_REQUESTED', 'RETURNED', 'REFUNDED'];
            ...
            <div className="flex flex-wrap gap-2">
              {statuses.map(status => (
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${(order.orderStatus || order.status) === status
