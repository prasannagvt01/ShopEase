        ...
        <div className="flex items-center justify-between h-16 lg:h-18">
          ...
          <form onSubmit={handleSearch} className="hidden md:flex flex-1 max-w-md mx-8">
            <div className={`relative w-full transition-all duration-300 ${isSearchFocused ? 'scale-105' : ''}`}>
              ...
              />
              <MagnifyingGlassIcon className={`absolute left-3.5 top-1/2 -translate-y-1/2 h-5 w-5 transition-colors ${isSearchFocused ? 'text-primary-500' : 'text-gray-400'
                }`} />
            </div>
          </form>
                      ...
                      <>
                        ...
                        <Menu.Item>
                          {({ active }) => (
                            <Link
                              to="/admin"
                              className={`flex items-center gap-3 px-4 py-2.5 text-sm ${active ? 'bg-primary-50 dark:bg-primary-900/20' : ''
